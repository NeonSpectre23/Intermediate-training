...
import com.group38.oj.model.dto.questionfavour.QuestionFavourAddRequest;
import com.group38.oj.model.dto.questionfavour.QuestionFavourQueryRequest;
...
public class QuestionFavourController {
    ...
    public BaseResponse<Page<QuestionVO>> listFavourQuestionByPage(@RequestBody QuestionFavourQueryRequest questionFavourQueryRequest,
        ...
        long current = questionFavourQueryRequest.getQuestionQueryRequest().getCurrent();
        long size = questionFavourQueryRequest.getQuestionQueryRequest().getPageSize();
